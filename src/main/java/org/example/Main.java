...
public class Main {
    public static void main(String[] args) {
        ...
        if (choice == 1) {
            ...
            if (authenticator.register(username, password)) {
                ...
                login(scanner, authenticator, moodTracker, dataManager);
            } else {
    ...
    private static void login(Scanner scanner, Authenticator authenticator, MoodTracker moodTracker,DataManager dataManager) {
        System.out.print("Enter username: ");
        String username = scanner.nextLine();
        System.out.print("Enter password: ");
        String password = scanner.nextLine();
        if (authenticator.login(username, password)) {
            ...
            inputDate(scanner, moodTracker, dataManager);
        } else {
            System.out.println("Invalid username or password.");
        }
    }

    private static void inputDate(Scanner scanner, MoodTracker moodTracker, DataManager dataManager) {
    ...
    private static void displayInnerMenu(Scanner scanner, MoodTracker moodTracker, DailyMood dailyMood, DataManager dataManager) {
        ...
        while (!exit) {
            ...
            switch (menuChoice) {
                case 1 -> addSleepEntry(scanner, dailyMood);
                case 2 -> addProductivityEntry(scanner, dailyMood);
                case 3 -> addWeatherEntry(scanner, dailyMood);
                case 4 -> addExerciseEntry(scanner, dailyMood);
                case 5 -> addFoodEntry(scanner, dailyMood);
                case 6 -> addScreenTimeEntry(scanner, dailyMood);
    ...
    private static void addWeatherEntry(Scanner scanner, DailyMood dailyMood) {
    ...
    private static void addExerciseEntry(Scanner scanner, DailyMood dailyMood) {
    ...
    private static void addFoodEntry(Scanner scanner, DailyMood dailyMood) {
    ...
    private static void addScreenTimeEntry(Scanner scanner, DailyMood dailyMood) {
